  ...
  describe('Secrets service', function() {
    ...
    describe('getPromise', function() {
      it("provides a promise", inject(function($q, $injector, $timeout) {
        var api = $injector.get('horizon.app.core.openstack-service-api.barbican');
        var deferred = $q.defer();
        spyOn(api, 'getSecrets').and.returnValue(deferred.promise);
        ...
        $timeout.flush();
        expect(api.getSecrets).toHaveBeenCalled();
